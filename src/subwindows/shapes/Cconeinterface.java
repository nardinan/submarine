...
public class Cconeinterface extends Cbasewindow {
    /* father's class */
    ...
    private JCheckBox solidBox, sideBox, bottomBox;
    private JButton submitButton, cancelButton;
    /* end */
    public Cconeinterface (Cmaininterface backTrack) {
        super(350, 570, "add a Cone", false, false, true);
    ...
    public void initializeComponent () {
        ...
        rPicture.setIcon(new javax.swing.ImageIcon(getClass().getResource("/arts/rcone.png")));
        hPicture.setIcon(new javax.swing.ImageIcon(getClass().getResource("/arts/hcone.png")));
