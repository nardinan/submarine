...
public class Csphereinterface extends Cbasewindow {
    /* father's class */
    ...
    private Cnumericdocument rSize;
    private JLabel rPicture;
    private JCheckBox solidBox;
    private JButton submitButton, cancelButton;
    /* end */
    public Csphereinterface (Cmaininterface backTrack) {
        super(350, 550, "add a Sphere", false, false, true);
    ...
    public void initializeComponent () {
        ...
        rPicture.setIcon(new javax.swing.ImageIcon(getClass().getResource("/arts/rsphere.png")));
    ...
    private void insertComplete () {
        ...
        if (headerBlock.nameSelect.isSelected()) {
            if ((!headerBlock.objectName.getText().equals("")) && (!rSize.getText().equals(""))) {
                completeString += " DEF='"+headerBlock.objectName.getText()+"' radius='"+
                        rSize.getText()+"' solid='"+
                        solidBox.isSelected()+"'/>\n\t\t\t<Appearance>\n\t\t\t\t<Material ";
